...
textfile = open(path.join(data_folder, "greater_london_cluster.txt"), "r")  # "greater_london_cluster.txt"
boroughs = textfile.read().split("\n")

boroughs_descriptor = "greater_london_cluster"  # "greater_london_cluster"
species = "NO2"
training_window = 14
quantile_step = 0.25
noise_std = 0.3
